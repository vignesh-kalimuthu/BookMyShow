...
const MovieHero = () => {
      ...
      <div className='relative hidden lg:block' style={{ height: '30rem' }}>
        ...
        <div className='absolute z-30  h-96 left-64 top-10'>
          ...
          <div className='absolute w-96  h-96 left-80  top-1 '>
            <div>
              ...
              <div className='border-2 border-white text-white px-5 py-2 rounded-lg flex justify-between'>
                <div >
              ...
              <div className='max-w-xs text-white mt-5 px-2 font-semibold rounded-sm '>
                2D, 3D, 4D, 5D, IMAX 2D, MX4D, 4DX
              </div>
              <div className=' text-white mt-2 px-2  font-semibold rounded-sm '>
                English , Kannada , Tamil , Hindi , Malayalam
              </div>
              <div className='text-white mt-2 px-2 text-base font-thin rounded-sm '>
        ...
        <div>
          <button className=' flex px-4 py-2 text-xl text-white bg-opacity-50 backdrop-filter backdrop-blur bg-navCol-800 absolute top-12 right-20 rounded-md'>
